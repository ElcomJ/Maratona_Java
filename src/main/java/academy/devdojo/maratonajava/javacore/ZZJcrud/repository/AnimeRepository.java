...
public class AnimeRepository {
    ...
    public static List<Anime> findByName(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find the anime", e);
        }
        return animes;
    }

    private static PreparedStatement createPrepareStatementFindByName(Connection conn, String name) throws SQLException { // Neste método usamos o Block Quote (Java 14)
        String sql = """
