...
/**
 * A lista é <b>static</b> porque ela não vai ser alterada.<br />
 * <b>ofNullable</b> retorna se o valor é nulo ou retorna o que espera<br />
 * Sempre lembrar de usar predicate para não duplicar código<br />
 *
 */
public class MangaRepository {
    private static List<Manga> mangas = List.of(
            new Manga(1, "Boku no Hero", 50),
            new Manga(2, "Overlod", 25)
    );
